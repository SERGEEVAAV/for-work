...
const getStrategiesWrapper = () => {
  const strategiesConstainer = document.querySelector('.carousel');
...
class Article {
  ...
  generateArticle() {
    ...
    if (this.img  || this.button) {
      template += `<h3 class="strategy animal__title">`

      this.title &&
      (template += `<h3 class="strategy animal__title">${this.title}</h3>`)
